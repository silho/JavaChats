 ...
 * @author yusij
 */
public class ListenUserRegister implements Runnable {

    private static final int PORT = 33501;
        ...
        try {
            ...
            for (;;) {
                try (Socket s = ss.accept()) {
                    ...
                    boolean result = CheckDB.checkAndInsertUsernameAndPassword(conn, usernameAndPassword[0], usernameAndPassword[1]);
